...
unsigned long signalReceivedTime = 0; // Track the time when signal is received from Device A
const long responseTime = 1000; // Maximum time allowed to respond to the signal (milliseconds)
